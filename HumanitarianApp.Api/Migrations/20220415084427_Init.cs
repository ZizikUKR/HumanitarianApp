    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    FullBankName = table.Column<string>(type: "TEXT", nullable: false),
                    ShortBankName = table.Column<string>(type: "TEXT", nullable: false),
                    IBAN = table.Column<string>(type: "TEXT", nullable: false),
                    AccountNumber = table.Column<string>(type: "TEXT", nullable: false),
                    MFO = table.Column<string>(type: "TEXT", nullable: false),
                    EDRPO = table.Column<string>(type: "TEXT", nullable: false),
