    ...
    return(
      <section className="section">
        <div className="section__form">
          ...
          {this.state.openForm ? (this.props.name === 'Волонтери' ? <Form id={this.props.id} title={'Анкета волонтера'} namePlaceholder={'Введіть ПІБ'} areaPlaceholder={null} selects={this.props.filterButtons} onOpenAgreement={this.props.onOpenAgreement} /> : null) : null}
          {this.state.openForm ? (this.props.name === 'Підприємства' ? <Form id={this.props.id} title={'Анкета підприємства'} namePlaceholder={'Назва підприємства'} areaPlaceholder={null} selects={this.props.filterButtons} onOpenAgreement={this.props.onOpenAgreement} /> : null) : null}
          {this.state.openForm ? (this.props.name === 'Оголошення' ? <Form id={this.props.id} title={'Додати оголошення'} namePlaceholder={'Введіть ПІБ'} areaPlaceholder={'Введить текст оголошення'} selects={this.props.filterButtons} onOpenAgreement={this.props.onOpenAgreement} /> : null) : null}
          </div>
